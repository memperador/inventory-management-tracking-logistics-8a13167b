        ...
        if (event === 'SIGNED_IN') {
          ...
          setTimeout(async () => {
            ...
            try {
              ...
              const now = new Date();
              const trialEndsAt = tenantData && 'trial_ends_at' in tenantData && tenantData.trial_ends_at 
                ? new Date(tenantData.trial_ends_at) 
                : null;
              const hasActiveSubscription = tenantData && 'subscription_status' in tenantData && 
